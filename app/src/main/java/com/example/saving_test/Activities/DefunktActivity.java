...
public class DefunktActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_defunkt);
        ...
        buttonGoToSecondActivity.setOnClickListener(v -> {
            Intent intent = new Intent(DefunktActivity.this, GridActivity.class);
        ...
        executor.execute(() -> {
            ...
            runOnUiThread(() -> {
                spielerAdapter = new ArrayAdapter<>(DefunktActivity.this, android.R.layout.simple_spinner_item, allSpieler);
                spielerAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

                AnlageAdapter = new ArrayAdapter<>(DefunktActivity.this, android.R.layout.simple_spinner_item, allAnlage);
                AnlageAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

                turnierAdapter = new ArrayAdapter<>(DefunktActivity.this, android.R.layout.simple_spinner_item, allTurnier);
            ...
            if (!name.isEmpty()) {
                ...
                executorplayer.execute(() -> {
                    ...
                    runOnUiThread(() -> {
                        ...
                        Toast.makeText(DefunktActivity.this, "Player added", Toast.LENGTH_SHORT).show();
                    });
                });
            }
        });
